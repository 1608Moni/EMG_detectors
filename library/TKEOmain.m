...
%             save(name,'-struct','TKEOOutput')
    ...
    %% format the data
        TKEOOp.binop      = Binaryop;
        TKEOOp.t0cap      = Onset;
        TKEOOp.params     = params;
        TKEOOp.dataparams = TKEOOutput.dataparams;
        TKEOOp.dataparams.SNR  = EMG.SNR;
        TKEOOp.dataparams.mode = EMG.mode;
