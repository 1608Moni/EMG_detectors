...
%%        
            ...
            [CFoutput] = agreementStats(output,algoname{a},string(type{k}));         
    ...
    figure
    boxplot(Cost_SNR0,'Label',algoname);
    ylabel('cohens kappa')
    if mode == "Test"
