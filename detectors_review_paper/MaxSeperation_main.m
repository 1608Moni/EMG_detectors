...
for i = 1:5:No_of_paramCombo
   l=25;
    %for l = 1:length(subfolders)
        ...
        for m = 1:1%length(sessionfolders)    
        ...
        %         for o = 1:length(Datatypes)
                    ...
                    %% For each parameter combination
                        ...
                        for j = 1:1%size(EMGdata.output,2)
...
%                         figure(1)
                          ...
                          subplot(1,2,1)
                          histogram(EMGdata.output{i,j}.testfunc(2002:end),'BinWidth',0.5,'Displaystyle','stairs')
%                         hold on
%                         xline(1,'r--')
                          hold on
...
%                          EMGdata.output{i, j}.paramcombo
        ...
        %end
        disp(['Completed computing seperation :', PatientfolderName, 'Combo', i]);
    end
    PdEMG = ProbDetEMG';
