...
ylabel('PDF (No of trials)');
xlabel('C, f({\Delta}t)ON, r_{FP}, r_{FN},f({\Delta}t)OFF')
set(gca,"FontSize",12)
set(gca, "LineWidth",1.1)
set(gca, 'Box', 'off')
xlim([0 0.4])
l=legend('C','f({{\Delta}t})ON','r_{FP}','r_{FN}','f({{\Delta}t})OFFs');
